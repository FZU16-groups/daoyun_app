...
public class SignInFinishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMember(0);
        memberAdapter = new MemberAdapter(SignInFinishActivity.this, R.layout.member_item, memberList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(SignInFinishActivity.this, member.getMemberName(), Toast.LENGTH_SHORT).show();
            }
        });
                            ...
                            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                                ...
                                if(responseBodyStr.equals("finish_succeed")){
                                    runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            AlertDialog.Builder builder = new AlertDialog.Builder(SignInFinishActivity.this)
    ...
    public void initMember(final int i){
        if(i == 1){
            progressDialog = new ProgressDialog(SignInFinishActivity.this);
